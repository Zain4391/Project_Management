...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <p>We're thrilled to have you onboard! Thank you for joining us.</p>
    <p>We’re excited to help you get started and make the most out of our services. Here are a few things you can do next:</p>
    <ul style="list-style: none; padding-left: 0;">
      <li><strong>Explore Features:</strong> Get to know all the great features that can help you achieve your goals.</li>
      <li><strong>Join the Community:</strong> Connect with others and share your experiences.</li>
      <li><strong>Reach Out:</strong> Our support team is always here if you need any assistance.</li>
    </ul>
    <p>If you have any questions, feel free to contact our team directly. We're here to help!</p>
    <p>Once again, welcome to the family, <strong>{username}</strong>! We're glad you're here.</p>
    <p>Best regards,<br>Your App Team</p>
  </div>
  <div style="text-align: center; margin-top: 20px; color: #888; font-size: 0.8em;">
    <p>This is an automated message, please do not reply to this email.</p>
